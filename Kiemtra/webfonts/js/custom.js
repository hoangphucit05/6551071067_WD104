(function ($) {
  ...
  $(document).ready(function () {
    ...
    // Toggle Best Seller Content
    $("#toggleBestSeller").on("click", function() {
      $(".best_product_slider").fadeToggle(500);
      $(this).text($(this).text() === "Ẩn nội dung" ? "Hiện nội dung" : "Ẩn nội dung");
    });
  });
  ...
  // Best Seller Toggle
  $("#toggleBestSeller").on("click", function() {
    $("#bestSellerContent").fadeToggle(500);
  });
